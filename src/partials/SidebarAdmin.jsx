        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
             ...
             {/* Profile */}
            <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('AdminProfile') && 'bg-slate-900'}`}>
                <NavLink
                  end
                  to="/AdminProfile"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes('AdminProfile') ? 'hover:text-slate-200' : 'hover:text-white'
                  }`}
                >
                  ...
                  >
                    <path
                     className={`fill-current ${pathname.includes('AdminProfile') ? 'text-indigo-500' : 'text-white'}`}
