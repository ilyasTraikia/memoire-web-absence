        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Change Password */}
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('teacherChangePass') && 'bg-slate-900'}`}>
                <NavLink
                  end
                  to="/teacherChangePass"
                  className={`block text-slate-200 truncate transition duration-150 ${
                    pathname.includes('teacherChangePass') ? 'hover:text-slate-200' : 'hover:text-white'
                  }`}
                >
                  <div className="flex items-center">
                  <svg
                        ...
                        >
                          <g clipPath='url(#clip0_130_9814)'>
                            <path
                             className={`fill-current ${pathname.includes('teacherChangePass') ? 'text-indigo-500' : 'text-white'}`}
